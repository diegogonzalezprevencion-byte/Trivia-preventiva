...
function renderAdmin() {
  ...
  $('#content').innerHTML = `
    ...
    <article class="card admin-section">
      <div class="toolbar"><div><h3>Banco de preguntas</h3><p class="card-subtitle">${questions.length} preguntas activas.</p></div><div class="toolbar-actions"><button id="export-data" class="btn ghost">Exportar datos</button><button id="reset-demo" class="btn danger">Reiniciar plataforma</button></div></div>
