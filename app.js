...
function bindAuth() {
  // El cambio visual de pestañas se maneja desde index.html para que siga
  // funcionando aun cuando la conexión a Supabase tarde en inicializar.
...
restoreSession().catch((error) => {
  ...
  showAuthError('La conexión con Supabase no pudo iniciarse. Recarga la página en unos segundos.');
});
