...
- Registro con correo corporativo `@consalud.cl`, clave y sucursal.
- Clave con mínimo 6 caracteres, una letra mayúscula y un número.
- Una trivia diaria por participante.
- Indicadores mensuales de respuestas correctas, incorrectas, efectividad y Estrellas.
...
- Cambio de correo corporativo, sucursal y restablecimiento de clave, además de eliminación de usuarios.
- Banco base de 600 preguntas con búsqueda por día, mes, año y texto.
- Botón para agregar nuevas preguntas a la programación.
...
- Sorteo exclusivo entre quienes tengan la mayor cantidad de Estrellas del periodo seleccionado.
